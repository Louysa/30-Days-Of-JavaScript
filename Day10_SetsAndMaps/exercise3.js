const countries = [
  ...
  function mostSpokenNLanguages(countries,n){
    ...
    const languageCount = [];
    for (const language of uniqueLanguagesArray) {
      let count = 0;
      for (const country of countries) {
    ...
    return languageCount.sort((a, b) => b.count - a.count).slice(0, n);
  }

  
  console.log(mostSpokenNLanguages(countries, 10))